...
Use data science models to predict the win placement of players in PUBG games. The data we use has 4.4 million entries for 29 different variables. See the kaggle competition here for the data and more information: https://www.kaggle.com/competitions/pubg-finish-placement-prediction/overview
